...
public class MongoTradingCardController {
    ...
    // âœ… Get all trading cards (Paginated & Sorted)
    @GetMapping
    ...
    // âœ… Get a single trading card by ID
    @GetMapping("/{id}")
    ...
    // âœ… Update an existing trading card
    @PutMapping("/{id}")
    ...
    // âœ… Search trading cards by name or contribution
    @GetMapping("/search")
